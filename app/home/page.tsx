...
const tamilRituals = [
  {
    ...
    time: "Morning",
    description: "A joyful ceremony where turmeric paste is applied to the bride by family and friends. Music, laughter, and warm wishes fill the air.",
    tierB: false,
  },
  {
    name: "Magapadi / Haldi for the Groom",
    time: "Late Morning",
    description: "The groom is similarly anointed with turmeric paste, signifying purification and blessing before the wedding ceremonies begin.",
    tierB: false,
  },
  {
    name: "Muhurtham / Sacred Thread Ceremony",
    time: "11:00 AM",
    description: "The groom is adorned with the sacred thread, signifying his readiness for the wedding rituals. Family elders offer their blessings.",
    tierB: false,
  },
  {
    name: "Kanyadaan",
    time: "Midday",
    description: "One of the most sacred rituals of a Hindu wedding — the father of the bride gives away his daughter to the groom, seeking divine blessings.",
    tierB: true,
  },
  {
    name: "Saptapadi — Seven Steps",
    time: "Core Ceremony",
    description: "The couple takes seven steps together around the sacred fire, each step accompanied by a solemn vow.",
    tierB: true,
  },
  {
    name: "Sindoor & Mangalsutra",
    time: "After Saptapadi",
    description: "The groom applies sindoor to the bride's hair partition and ties the mangalsutra, signifying their sacred bond of marriage.",
    tierB: true,
  },
  {
    name: "Ashirvad — Blessings",
    time: "Post Ceremony",
    description: "Elders from both families gather to bestow their blessings upon the newlyweds.",
    tierB: false,
  },
];
