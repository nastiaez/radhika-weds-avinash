    ...
    <div className={`wedding-page lang-${lang}`}>
      ...
      <nav ref={navRef} style={{ opacity: 0, transition: "opacity 0.4s ease" }}>
        ...
        <ul className="nav-links">
          {isFamily && <li><a href="#story">{t.nav.ourStory}</a></li>}
      ...
      <section id="info">
        <div className="section-inner">
          <h2 className="section-title scroll-reveal">{t.info.sectionTitle}</h2>
          <div className="info-grid">
            <div className="info-card scroll-reveal" style={{ transitionDelay: "0ms" }}>
            ...
            {isFamily && (
              <div className="info-card scroll-reveal" style={{ transitionDelay: "100ms" }}>
                <div className="info-card-icon">{t.info.whenLabel}</div>
                <h3>{t.info.whenDate2}</h3>
                <p>{t.info.whenTime2}</p>
              </div>
            )}
            <div className="info-card scroll-reveal" style={{ transitionDelay: isFamily ? "200ms" : "100ms" }}>
          ...
          <div className="info-blocks-grid">
            <div className="info-block scroll-reveal" style={{ transitionDelay: "0ms" }}>
              <div className="info-block-label">{t.info.phonesLabel}</div>
              <h3>{t.info.phonesTitle}</h3>
              <p>{t.info.phonesBody}</p>
            </div>
            <div className="info-block scroll-reveal" style={{ transitionDelay: "100ms" }}>
      ...
      >
        <div className="section-inner">
          <h2 className="section-title scroll-reveal">{t.schedule.sectionTitle}</h2>
          <p className="schedule-venue-note scroll-reveal">{t.schedule.venueNote}</p>

          <p className="schedule-day-label scroll-reveal">{t.schedule.day1Label}</p>
          <div className="schedule-list">
            {isFamily && (
              <div className="schedule-event scroll-reveal">
          ...
          {isFamily && (
            <>
              <p className="schedule-day-label scroll-reveal">{t.schedule.day2Label}</p>
              <div className="schedule-list">
                <div className="schedule-event scroll-reveal">
                  <div className="schedule-dot" />
      ...
      <section id="venue">
        <div className="section-inner">
          <h2 className="section-title scroll-reveal">{t.venue.sectionTitle}</h2>
          <div className="venue-photos">
            <div className="venue-photo scroll-reveal sr-fade" style={{ transitionDelay: "0ms" }}>
              <img src="/media/Dwaraka-1.jpg" alt="Dwaraka Palace dining" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
            <div className="venue-photo scroll-reveal sr-fade" style={{ transitionDelay: "80ms" }}>
              <img src="/media/DWARAKA-mid.jpg" alt="Dwaraka Palace hall" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
            <div className="venue-photo scroll-reveal sr-fade" style={{ transitionDelay: "160ms" }}>
              <img src="/media/DWARAKA-3.jpg" alt="Dwaraka Palace garden" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
          </div>
          <div className="venue-details">
            <div className="venue-address scroll-reveal">
            ...
            <div className="map-embed scroll-reveal sr-fade" style={{ transitionDelay: "100ms" }}>
              <iframe
      ...
      >
        <div className="section-inner">
          ...
          <div className="faq-list">
            <div className="faq-group-label scroll-reveal">{t.faq.photosGroupLabel}</div>
            ...
            <div className="faq-group-label scroll-reveal">{t.faq.giftsGroupLabel}</div>
            <div className="faq-item scroll-reveal">
              <h3>{t.faq.q5Title}</h3>
              <p>{t.faq.q5Body}</p>
            </div>

            <div className="faq-group-label scroll-reveal">{t.faq.venueGroupLabel}</div>
            <div className="faq-item scroll-reveal">
              <h3>{t.faq.q6Title}</h3>
              <p>{t.faq.q6Body}</p>
            </div>
            ...
            <div className="faq-group-label scroll-reveal">{t.faq.foodGroupLabel}</div>
            <div className="faq-item scroll-reveal">
              <h3>{t.faq.q9Title}</h3>
              <p>{showDay1 ? t.faq.q9BodyFamily : t.faq.q9BodyAll}</p>
            </div>

            <div className="faq-group-label scroll-reveal">{t.faq.ceremoniesGroupLabel}</div>
            <div className="faq-item scroll-reveal">
